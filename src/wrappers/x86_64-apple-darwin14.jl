# Autogenerated wrapper script for mpg123_jll for x86_64-apple-darwin14
...
const libmpg123_splitpath = ["lib", "libmpg123.0.dylib"]
...
const libmpg123 = "@rpath/libmpg123.0.dylib"


# Relative path to `libout123`
const libout123_splitpath = ["lib", "libout123.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libout123 = "@rpath/libout123.0.dylib"
