...
const mpg123_strip_splitpath = ["bin", "mpg123-strip.exe"]
...
const mpg123_id3dump_splitpath = ["bin", "mpg123-id3dump.exe"]
...
const libmpg123_splitpath = ["bin", "libmpg123-0.dll"]
...
const libmpg123 = "libmpg123-0.dll"


# Relative path to `libout123`
const libout123_splitpath = ["bin", "libout123-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libout123 = "libout123-0.dll"


# Relative path to `out123`
const out123_splitpath = ["bin", "out123.exe"]
...
const mpg123_splitpath = ["bin", "mpg123.exe"]
